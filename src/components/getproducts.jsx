...
const Getproducts = () => {
  ...
  // Specify the location URL to the images
  ...
  const applyFilters = () => {
    ...
    if (filters.searchQuery) {
      filtered = filtered.filter(product =>
        ...
        product.product_description.toLowerCase().includes(filters.searchQuery.toLowerCase())
      );
    }
    ...
    switch (filters.sortBy) {
      case "price-low-high":
        filtered.sort((a, b) => parseFloat(a.product_cost) - parseFloat(b.product_cost));
        break;
      case "price-high-low":
        filtered.sort((a, b) => parseFloat(b.product_cost) - parseFloat(a.product_cost));
        break;
      case "name":
